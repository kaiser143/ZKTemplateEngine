...
RUBY
    ...
    def rename_files
      ...
      unless @remove_demo_target
        ...
        ["CPDViewControllerIntercepter.h", "CPDViewControllerIntercepter.m"].each do |file|
    ...
    def rename_project_folder
      if Dir.exist? project_folder + "/PROJECT/Classes/PROJECT"
        File.rename(project_folder + "/PROJECT/Classes/PROJECT", project_folder + "/PROJECT/Classes/" + @configurator.pod_name)
      end
      ...
      if Dir.exist? project_folder + "/PROJECTUITests"
        File.rename(project_folder + "/PROJECTUITests", project_folder + "/" + @configurator.pod_name + "UITests")
      end
    end
